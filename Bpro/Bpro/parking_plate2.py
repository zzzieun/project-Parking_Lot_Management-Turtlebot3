...
def main(args=None):
    ...
    try:
        while rclpy.ok():
            rclpy.spin_once(node_laser, timeout_sec = 0.1)
            if len(node_laser.scan.ranges) != 360:
                pass
            else:
                if node_laser.scan.ranges[180] > 0.1:
                    a=1
                else:
                    ...
                    if frame is None:
                        ...
                        print(chars)     
                        os.system("ros2 param set /reg_params z2_plate " + chars)
                        print("-----------------------------")
                        os.system("ros2 run Bpro parking_lot3")
                        print("go waypoint3")   
                                
    except KeyboardInterrupt:
        node_laser.get_logger().info('Keyboard Interrupt(SIGINT)')
